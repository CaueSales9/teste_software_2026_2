from backend.exceptions.excecoes import NomeInvalidoError, QntEstoqueError, ValidadeError, CodigoDeBarrasError, CategoriaError, PesoError, PrecoError
